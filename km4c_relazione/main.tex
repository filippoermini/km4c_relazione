...
Nell'esempio è riportato un blocco di triple suddiviso per classi. Ogni classe possiede obbligatoriamente l'attributo \textttt{http://www.w3.org/1999/02/22-rdf-syntax-ns#type} che identifica la classe alla quale appartiene quella risorsa.
...
delle classi che definiscono il sensore. Tale file è scritto con la sintassi \emp{XML}.
...
\end{itemize}
A partire dalla cartella specificata sarà creata un'alberatura di cartelle con il seguente formato: \emph{AAAA_MM\\GG\\hh\\mmss\\nomefile.n3}.
